...
> [!TIP]
> Para definições técnicas de habilidades específicas (como Veneno, Atropelar, etc.), consulte o **[Glossário de Palavras-Chave](Palavras_Chave.md)**.
...
Antes dos "socos serem trocados", abre-se a janela para os jogadores usarem mágicas rápidas (**[Reações](../Regras/Palavras_Chave.md#reação)**, **[Tocaia](../Regras/Palavras_Chave.md#tocaia-x)**, Buffs). Elas são resolvidas aqui usando a regra da **Corrente de Habilidades**.
